...
import { StartPointSelection } from './tools/startpoint-selection';
import { EndPointSelection } from './tools/endpoint-selection';
...
const main = async () => {
    ...
    toolManager.register(new StartPointSelection(events, editorUI.canvasContainer.dom));
    toolManager.register(new EndPointSelection(events, editorUI.canvasContainer.dom));
